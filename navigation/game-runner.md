...
class CustomLevel {
    constructor(gameEnv) {
        ...
        const npcData1 = {
            id: 'NPC',
            greeting: 'P diddy will cum to your house, #diddlenation',
            ...
            dialogues: ['P diddy will cum to your house, #diddlenation'],
            reaction: function() { if (this.dialogueSystem) { this.showReactionDialogue(); } else { console.log(this.greeting); } },
            interact: function() { if (this.dialogueSystem) { this.showRandomDialogue(); } }
        };

        const barrierData1 = {
            id: 'wall_1', x: 487, y: 381, width: 150, height: 20, visible: true,
